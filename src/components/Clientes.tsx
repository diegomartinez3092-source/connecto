  ...
  "1": [
    {
      ...
      fecha: "2025-09-15",
      total: 125000,
      productos: "Lámina galvanizada, PTR 2x2",
      estado: "entregado",
    },
    {
      id: "c2",
      ...
      fecha: "2025-08-20",
      total: 98000,
      productos: "Varilla corrugada, Alambrón",
      estado: "entregado",
    },
    {
      id: "c3",
      ...
      fecha: "2025-07-10",
      total: 156000,
      productos: "Perfil PTR 4x4, Ángulo estructural",
      estado: "entregado",
    },
  ],
};
  ...
  "1": [
    {
      ...
      contenido:
        "Cliente solicitó cotización para nuevo proyecto de construcción. Requiere entrega para noviembre.",
    },
    {
      id: "n2",
      fecha: "2025-09-28",
      autor: "María González",
      contenido: "Confirmó recepción de material. Muy satisfecho con la calidad del producto.",
    },
  ],
};
...
export function Clientes({ onNavigate, clienteDetalleId, onClienteDetalleClose }: ClientesProps) {
  ...
  // handler para botón de prueba con Make
  const handlePruebaMake = async () => {
    try {
      await fetch("https://hook.us2.make.com/gu47je17b5rtviqhaz5aet57cdmrfiuj", {
        method: "POST",
        headers: {
      ...
      console.log("Se envió hola mundo a Make");
    } catch (error) {
  ...
  if (clienteDetalleId) {
    ...
    if (!cliente) {
      return (
        <div className="space-y-6 text-black">
          ...
          <Button className="mt-4" onClick={handlePruebaMake}>
            Prueba Make
          </Button>
        </div>
      );
    ...
    return (
      <div className="space-y-6 text-black">
                  ...
                  <TableBody>
                    {(mockCotizaciones[cliente.id] || []).map((cot) => (
                      <TableRow key={cot.id}>
                        ...
                        <TableCell>
                          <Badge
                            variant={cot.estado === "aceptada" ? "default" : "outline"}
                          >
                            {cot.estado}
                          </Badge>
                        </TableCell>
        ...
        {/* Botón de prueba Make al final de la vista de detalle */}
        <Button className="mt-4" onClick={handlePruebaMake}>
          Prueba Make
        </Button>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <Select
              value={filterEstadoPagos}
              onValueChange={setFilterEstadoPagos}
            >
              <SelectTrigger>
            ...
            <Select
              ...
              onValueChange={setFilterEjecutivo}
            >
              <SelectTrigger>
