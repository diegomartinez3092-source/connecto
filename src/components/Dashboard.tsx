      ...
      <section className="space-y-4">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground max-w-2xl">
              Los agentes digitales están listos para ayudarte a vender y dar seguimiento. Consulta su estado y entra directo a cada dashboard.
            </p>
          </div>
          <div className="flex flex-wrap gap-3">
            ...
            <Button
              className="gap-2"
              onClick={() => onNavigate("empleados-digitales-vendedor-digital")}
            >
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <Card className="border-[#E0E0E0]">
            ...
            <CardContent>
              <p className="text-3xl font-semibold text-[#242424]">
                {centerMetrics.activos} activos
              </p>
              <p className="text-sm text-muted-foreground">
                {centerMetrics.enAlerta} en alerta
              </p>
            </CardContent>
          </Card>
          <Card className="border-[#E0E0E0]">
            ...
            <CardContent>
              <p className="text-3xl font-semibold text-[#242424]">
                {centerMetrics.tiempoRespuestaPromedio}
              </p>
          ...
          <Card className="border-[#E0E0E0]">
            ...
            <CardContent>
              <p className="text-3xl font-semibold text-[#242424]">
                {centerMetrics.ingresos7d}
              </p>
              <p className="text-sm text-muted-foreground">
                {centerMetrics.pagosPendientes} pagos pendientes
              </p>
            </CardContent>
          </Card>
        </div>
                    ...
                    <span
                      className={
                        employee.status === "alert"
                          ...
                          : "rounded-full bg-emerald-100 text-emerald-800 px-3 py-1 text-xs border border-emerald-200"
                      }
                    >
                      {employee.availability ||
                        (employee.status === "alert" ? "En alerta" : "Activo")}
                    </span>
                  </div>
